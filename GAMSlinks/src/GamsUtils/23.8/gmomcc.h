 ...
 * generated by apiwrapper - $Rev: 30930 $ - $Date: 2012-01-05 09:52:59 -0500 (Thu, 05 Jan 2012) $
 */
...
typedef int  (GMO_CALLCONV *gmoGetObjQ_t) (gmoHandle_t pgmo, int colidx[], int rowidx[], double jacval[]);
...
typedef int  (GMO_CALLCONV *gmoGetRowQ_t) (gmoHandle_t pgmo, int si, int colidx[], int rowidx[], double jacval[]);
