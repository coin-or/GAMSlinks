/*  C code generated by apiwrapper - $Rev: 30930 $ - $Date: 2012-01-05 09:52:59 -0500 (Thu, 05 Jan 2012) $ */
...
int  GMO_CALLCONV d_gmoGetObjQ (gmoHandle_t pgmo, int colidx[], int rowidx[], double jacval[])
...
int  GMO_CALLCONV d_gmoGetRowQ (gmoHandle_t pgmo, int si, int colidx[], int rowidx[], double jacval[])
...
XLibraryLoad (const char *dllName, char *errBuf, int errBufSize)
{
  ...
  if (!gmoXAPIVersion(10,errBuf,&cl))
    return 1;
