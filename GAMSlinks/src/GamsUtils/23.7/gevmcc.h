...
typedef int  (GEV_CALLCONV *gevGetSlvExeInfo_t) (gevHandle_t pgev, const char *algid, char *exeName);
...
typedef int  (GEV_CALLCONV *gevCallSolver_t) (gevHandle_t pgev, void *gmoptr, const char *cntrfn, const char *solver, int solvelink, int logging, const char *logfn, const char *statfn, double reslim, int iterlim, int domlim, double optcr, double optca, char *msg);
GEV_FUNCPTR(gevCallSolver);
typedef int  (GEV_CALLCONV *gevAlgToNum_t) (gevHandle_t pgev, const char *algid);
GEV_FUNCPTR(gevAlgToNum);
typedef char * (GEV_CALLCONV *gevNumToAlg_t) (gevHandle_t pgev, int algnum, char *buf);
GEV_FUNCPTR(gevNumToAlg);
typedef int  (GEV_CALLCONV *gevNumAlgs_t) (gevHandle_t pgev);
GEV_FUNCPTR(gevNumAlgs);
...
typedef void  (GEV_CALLCONV *gevSetJacPermLegacy_t) (gevHandle_t pgev, void *evalptr, int cnt, int jacs[], int gms2slv[]);
...
typedef int  (GEV_CALLCONV *gevEvalJacLegacy_t) (gevHandle_t pgev, void *evalptr, int si, double x[], double *f, double jac[], int *domviol, int *jacupd);
