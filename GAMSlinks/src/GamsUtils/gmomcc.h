...
typedef int  (GMO_CALLCONV *gmoGetObjVector_t) (gmoHandle_t pgmo, double *ObjVector);
...
typedef void  (GMO_CALLCONV *gmoGetJacInfoOne_t) (gmoHandle_t pgmo, int sj, void **jacp, double *aval, int *irow, int *nzind);
GMO_FUNCPTR(gmoGetJacInfoOne);
...
typedef void  (GMO_CALLCONV *gmoGetVarBas_t) (gmoHandle_t pgmo, int *BasVector);
GMO_FUNCPTR(gmoGetVarBas);
typedef int  (GMO_CALLCONV *gmoGetVarBasOne_t) (gmoHandle_t pgmo, int sj);
GMO_FUNCPTR(gmoGetVarBasOne);
...
typedef void  (GMO_CALLCONV *gmoGetEquBas_t) (gmoHandle_t pgmo, int *BasVector);
GMO_FUNCPTR(gmoGetEquBas);
typedef int  (GMO_CALLCONV *gmoGetEquBasOne_t) (gmoHandle_t pgmo, int si);
GMO_FUNCPTR(gmoGetEquBasOne);
...
typedef int  (GMO_CALLCONV *gmoEvalGrad_t) (gmoHandle_t pgmo, int si, const double *X, double *f, double *g, double *gx);
...
typedef int  (GMO_CALLCONV *gmoEvalObjFunc_t) (gmoHandle_t pgmo, const double *X, double *f);
GMO_FUNCPTR(gmoEvalObjFunc);
typedef int  (GMO_CALLCONV *gmoEvalObjFuncNL_t) (gmoHandle_t pgmo, const double *X, double *fnl);
GMO_FUNCPTR(gmoEvalObjFuncNL);
typedef int  (GMO_CALLCONV *gmoEvalObjGrad_t) (gmoHandle_t pgmo, const double *X, double *f, double *g, double *gx);
GMO_FUNCPTR(gmoEvalObjGrad);
typedef int  (GMO_CALLCONV *gmoEvalObjGradNL_t) (gmoHandle_t pgmo, const double *X, double *fnl, double *g, double *gxnl);
GMO_FUNCPTR(gmoEvalObjGradNL);
typedef int  (GMO_CALLCONV *gmoTaylorExpInt_t) (gmoHandle_t pgmo);
GMO_FUNCPTR(gmoTaylorExpInt);
...
typedef int  (GMO_CALLCONV *gmoEvalGradNLInt_t) (gmoHandle_t pgmo, double *rhsdelta, int storejacupd);
...
typedef int  (GMO_CALLCONV *gmoDirtySetRowFNLInstr_t) (gmoHandle_t pgmo, int si, int len, const int *opcode, const int *field, int Npool, const double *poolx);
GMO_FUNCPTR(gmoDirtySetRowFNLInstr);
typedef int  (GMO_CALLCONV *gmoHessLoad_t) (gmoHandle_t pgmo, int MinJacMult, int MaxJacMult, int *do2dir, int *dohess);
GMO_FUNCPTR(gmoHessLoad);
typedef int  (GMO_CALLCONV *gmoHessUnload_t) (gmoHandle_t pgmo);
GMO_FUNCPTR(gmoHessUnload);
typedef int  (GMO_CALLCONV *gmoHessEffort_t) (gmoHandle_t pgmo, int si);
GMO_FUNCPTR(gmoHessEffort);
...
typedef int  (GMO_CALLCONV *gmoHessStruct_t) (gmoHandle_t pgmo, int si, int *JRindex, int *HRindex, int *HCindex, int *HessDim, int *HessNz);
GMO_FUNCPTR(gmoHessStruct);
typedef int  (GMO_CALLCONV *gmoHessValue_t) (gmoHandle_t pgmo, int si, int *JRindex, int *HRindex, int *HCindex, int *HessDim, int *HessNz, double *Xval, double *fun, double *Jval, double *Hval);
GMO_FUNCPTR(gmoHessValue);
typedef int  (GMO_CALLCONV *gmoHessVec_t) (gmoHandle_t pgmo, int si, double *X, double *dx, double *Wdx);
...
typedef int  (GMO_CALLCONV *gmoHessLagValue_t) (gmoHandle_t pgmo, double *X, double *u, double *w, double objWeight, double conWeight);
GMO_FUNCPTR(gmoHessLagValue);
typedef int  (GMO_CALLCONV *gmoHessLagVec_t) (gmoHandle_t pgmo, double *X, double *u, double *dx, double *Wdx);
GMO_FUNCPTR(gmoHessLagVec);
typedef int  (GMO_CALLCONV *gmoHessLagValueXX_t) (gmoHandle_t pgmo, double *X, double *u, double *w, double objWeight, double conWeight);
GMO_FUNCPTR(gmoHessLagValueXX);
...
typedef char * (GMO_CALLCONV *gmoIdent_t) (gmoHandle_t pgmo, char *buf);
GMO_FUNCPTR(gmoIdent);
typedef void (GMO_CALLCONV *gmoIdentSet_t) (gmoHandle_t pgmo, const char *x);
GMO_FUNCPTR(gmoIdentSet);
...
typedef int  (GMO_CALLCONV *gmoNLCode_t) (gmoHandle_t pgmo);
GMO_FUNCPTR(gmoNLCode);
typedef void (GMO_CALLCONV *gmoNLCodeSet_t) (gmoHandle_t pgmo, const int x);
GMO_FUNCPTR(gmoNLCodeSet);
...
GMO_FUNCPTR(gmoNLN);
typedef int  (GMO_CALLCONV *gmoNLScratch_t) (gmoHandle_t pgmo);
GMO_FUNCPTR(gmoNLScratch);
typedef void (GMO_CALLCONV *gmoNLScratchSet_t) (gmoHandle_t pgmo, const int x);
GMO_FUNCPTR(gmoNLScratchSet);
...
typedef int  (GMO_CALLCONV *gmoMaxSingleNL_t) (gmoHandle_t pgmo);
GMO_FUNCPTR(gmoMaxSingleNL);
