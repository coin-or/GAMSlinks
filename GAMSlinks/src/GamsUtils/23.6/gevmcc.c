...
#define CheckAndLoad(f,nargs,prefix) \
  ...
  {int s[]={3,1}; CheckAndLoad(gevInitJacLegacy,1,""); }
  {int s[]={0,3,8,3,8}; CheckAndLoad(gevSetColRowPermLegacy,4,""); }
  {int s[]={0,3,8,8}; CheckAndLoad(gevSetJacPermLegacy,3,""); }
  {int s[]={3,3,6,22,6,21,21}; CheckAndLoad(gevEvalJacLegacy,6,""); }
  {int s[]={3,3}; CheckAndLoad(gevNextNLLegacy,1,""); }
  {int s[]={3,3}; CheckAndLoad(gevRowGms2SlvLegacy,1,""); }
