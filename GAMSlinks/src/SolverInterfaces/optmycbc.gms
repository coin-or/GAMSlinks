...
$onembedded
set optdata(g,o,t,f) /
  gr_General_Options.'reslim'.R.(def 1e+100, lo -1, ref 184)
  ...
  gr_LP_Options.'idiotCrash'.I.(def -1, lo -1, ref 88)
  gr_LP_Options.'sprintCrash'.I.(def -1, lo -1, ref 196)
  gr_LP_Options.'crash'.S.(def 'off', ref 22)
  gr_LP_Options.'factorization'.S.(def 'normal', ref 71)
  gr_LP_Options.'denseThreshold'.I.(def -1, lo -1, up 10000, ref 31)
  gr_LP_Options.'smallFactorization'.I.(def -1, lo -1, up 10000, ref 188)
  gr_LP_Options.'sparseFactor'.B.(def 1, ref 194)
  gr_LP_Options.'biasLU'.S.(def 'LX', ref 11)
  gr_LP_Options.'maxFactor'.I.(def 200, lo 1, ref 103)
  gr_LP_Options.'crossover'.S.(def 'on', ref 23)
  gr_LP_Options.'dualPivot'.S.(def 'automatic', ref 54)
  gr_LP_Options.'primalPivot'.S.(def 'automatic', ref 150)
  gr_LP_Options.'psi'.R.(def -0.5, lo -1.1, up 1.1, ref 154)
  gr_LP_Options.'perturbation'.B.(def 1, ref 140)
  gr_LP_Options.'scaling'.S.(def 'automatic', ref 183)
  gr_LP_Options.'presolve'.S.(def 'on', ref 147)
  gr_LP_Options.'passPresolve'.I.(def 5, lo -200, up 100, ref 137)
  gr_LP_Options.'substitution'.I.(def 3, up 10000, ref 201)
  gr_LP_Options.'randomSeedClp'.I.(def 1234567, ref 166)
  gr_LP_Options.'tol_primal'.R.(def 1e-07, lo 1e-20, ref 152)
  gr_LP_Options.'tol_dual'.R.(def 1e-07, lo 1e-20, ref 56)
  gr_LP_Options.'tol_presolve'.R.(def 1e-08, lo 1e-20, ref 149)
  gr_LP_Options.'startalg'.S.(def 'dual', ref -1)
  gr_LP_Options.'primalWeight'.R.(def 1e+10, lo 1e-20, ref 153)
  gr_LP_Options.'autoScale'.B.(def 0, ref 7)
  gr_LP_Options.'bscale'.S.(def 'off', ref 13)
  gr_LP_Options.'gamma'.S.(def 'off', ref 78)
  gr_LP_Options.'KKT'.B.(def 0, ref 95)
  gr_MIP_Options.'threads'.I.(def 1, lo 1, up 99, ref 203)
  gr_MIP_Options.'parallelmode'.S.(def 'deterministic', ref -1)
  gr_MIP_Options.'strategy'.I.(def 1, up 2, ref 199)
  gr_MIP_Options.'mipstart'.B.(def 0, ref -1)
  gr_MIP_Options.'tol_integer'.R.(def 1e-07, lo 1e-20, up 0.5, ref 93)
  gr_MIP_Options.'sollim'.I.(def maxint, lo 1, ref 107)
  gr_MIP_Options.'dumpsolutions'.S.(def '', ref -1)
  gr_MIP_Options.'dumpsolutionsmerged'.S.(def '', ref -1)
  gr_MIP_Options.'maxsol'.I.(def 100, ref 106)
  gr_MIP_Options.'strongBranching'.I.(def 5, ref 200)
  gr_MIP_Options.'trustPseudoCosts'.I.(def 10, lo -3, ref 207)
  gr_MIP_Options.'expensiveStrong'.I.(def 0, ref 64)
  gr_MIP_Options.'OrbitalBranching'.S.(def 'off', ref 130)
  gr_MIP_Options.'costStrategy'.S.(def 'off', ref 19)
  gr_MIP_Options.'extraVariables'.I.(def 0, lo minint, ref 70)
  gr_MIP_Options.'multipleRootPasses'.I.(def 0, ref 118)
  gr_MIP_Options.'nodeStrategy'.S.(def 'fewest', ref 127)
  gr_MIP_Options.'infeasibilityWeight'.R.(def 0, ref 91)
  gr_MIP_Options.'preprocess'.S.(def 'sos', ref 148)
  gr_MIP_Options.'fixOnDj'.R.(def -1, lo mindouble, ref 74)
  gr_MIP_Options.'printfrequency'.I.(def 0, ref -1)
  gr_MIP_Options.'randomSeedCbc'.I.(def -1, lo -1, ref 164)
  gr_MIP_Options.'loglevel'.I.(def 1, ref -1)
  gr_MIP_Options.'increment'.R.(def 1e-05, lo mindouble, ref 90)
  ...
  gr_MIP_Options.'nodlim'.I.(def maxint, lo -1, ref 105)
  gr_MIP_Options.'optca'.R.(def 1e-10, ref 4)
  gr_MIP_Options.'optcr'.R.(def 0, ref 167)
  gr_MIP_Options.'cutoff'.R.(def 1e+100, lo mindouble, ref 27)
  gr_MIP_Options.'cutoffConstraint'.S.(def 'off', ref 18)
  gr_MIP_Options.'sosPrioritize'.S.(def 'off', ref 193)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cutDepth'.I.(def -1, lo -1, ref 25)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cut_passes_root'.I.(def 20, lo minint, ref 135)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cut_passes_tree'.I.(def 10, lo minint, ref 138)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cut_passes_slow'.I.(def 10, lo -1, ref 186)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cutLength'.I.(def -1, lo -1, ref 26)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cuts'.S.(def 'on', ref 28)
  gr_MIP_Options_for_Cutting_Plane_Generators.'cliqueCuts'.S.(def 'ifmove', ref 15)
  gr_MIP_Options_for_Cutting_Plane_Generators.'conflictcuts'.B.(def 0)
  gr_MIP_Options_for_Cutting_Plane_Generators.'flowCoverCuts'.S.(def 'ifmove', ref 75)
  gr_MIP_Options_for_Cutting_Plane_Generators.'gomoryCuts'.S.(def 'ifmove', ref 80)
  gr_MIP_Options_for_Cutting_Plane_Generators.'gomorycuts2'.S.(def 'off', ref 79)
  gr_MIP_Options_for_Cutting_Plane_Generators.'knapsackCuts'.S.(def 'ifmove', ref 96)
  gr_MIP_Options_for_Cutting_Plane_Generators.'liftAndProjectCuts'.S.(def 'off', ref 99)
  gr_MIP_Options_for_Cutting_Plane_Generators.'mirCuts'.S.(def 'ifmove', ref 112)
  gr_MIP_Options_for_Cutting_Plane_Generators.'twoMirCuts'.S.(def 'root', ref 209)
  gr_MIP_Options_for_Cutting_Plane_Generators.'probingCuts'.S.(def 'ifmove', ref 158)
  gr_MIP_Options_for_Cutting_Plane_Generators.'reduceAndSplitCuts'.S.(def 'off', ref 172)
  gr_MIP_Options_for_Cutting_Plane_Generators.'reduceAndSplitCuts2'.S.(def 'off', ref 173)
  gr_MIP_Options_for_Cutting_Plane_Generators.'residualCapacityCuts'.S.(def 'off', ref 174)
  gr_MIP_Options_for_Cutting_Plane_Generators.'zeroHalfCuts'.S.(def 'ifmove', ref 217)
  gr_MIP_Options_for_Cutting_Plane_Generators.'lagomoryCuts'.S.(def 'off', ref 97)
  gr_MIP_Options_for_Cutting_Plane_Generators.'latwomirCuts'.S.(def 'off', ref 98)
  gr_MIP_Options_for_Primal_Heuristics.'heuristics'.B.(def 1, ref 84)
  gr_MIP_Options_for_Primal_Heuristics.'hOptions'.I.(def 0, lo minint, ref 86)
  gr_MIP_Options_for_Primal_Heuristics.'combineSolutions'.S.(def 'off', ref 16)
  gr_MIP_Options_for_Primal_Heuristics.'combine2Solutions'.S.(def 'off', ref 17)
  gr_MIP_Options_for_Primal_Heuristics.'Dins'.S.(def 'off', ref 36)
  gr_MIP_Options_for_Primal_Heuristics.'DivingRandom'.S.(def 'off', ref 44)
  gr_MIP_Options_for_Primal_Heuristics.'DivingCoefficient'.S.(def 'off', ref 45)
  gr_MIP_Options_for_Primal_Heuristics.'DivingFractional'.S.(def 'off', ref 46)
  gr_MIP_Options_for_Primal_Heuristics.'DivingGuided'.S.(def 'off', ref 47)
  gr_MIP_Options_for_Primal_Heuristics.'DivingLineSearch'.S.(def 'off', ref 48)
  gr_MIP_Options_for_Primal_Heuristics.'DivingPseudoCost'.S.(def 'off', ref 49)
  gr_MIP_Options_for_Primal_Heuristics.'DivingVectorLength'.S.(def 'off', ref 50)
  gr_MIP_Options_for_Primal_Heuristics.'diveSolves'.I.(def 100, lo -1, up 200000, ref 43)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump'.S.(def 'on', ref 73)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump_passes'.I.(def 20, up 10000, ref 136)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump_artcost'.R.(def 0, ref 6)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump_fracbab'.R.(def 0.5, lo 1e-05, up 1.1, ref 77)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump_cutoff'.R.(def 0, lo mindouble, ref 160)
  gr_MIP_Options_for_Primal_Heuristics.'feaspump_increment'.R.(def 0, lo mindouble, ref 161)
  gr_MIP_Options_for_Primal_Heuristics.'greedyHeuristic'.S.(def 'on', ref 81)
  gr_MIP_Options_for_Primal_Heuristics.'localTreeSearch'.B.(def 0, ref 100)
  gr_MIP_Options_for_Primal_Heuristics.'naiveHeuristics'.S.(def 'off', ref 119)
  gr_MIP_Options_for_Primal_Heuristics.'pivotAndFix'.S.(def 'off', ref 143)
  gr_MIP_Options_for_Primal_Heuristics.'randomizedRounding'.S.(def 'off', ref 165)
  gr_MIP_Options_for_Primal_Heuristics.'Rens'.S.(def 'off', ref 178)
  gr_MIP_Options_for_Primal_Heuristics.'Rins'.S.(def 'off', ref 179)
  gr_MIP_Options_for_Primal_Heuristics.'roundingHeuristic'.S.(def 'on', ref 180)
  gr_MIP_Options_for_Primal_Heuristics.'vubheuristic'.I.(def -1, lo -2, up 20, ref 216)
  gr_MIP_Options_for_Primal_Heuristics.'proximitySearch'.S.(def 'off', ref 159)
  gr_MIP_Options_for_Primal_Heuristics.'dwHeuristic'.S.(def 'off', ref 57)
  gr_MIP_Options_for_Primal_Heuristics.'pivotAndComplement'.S.(def 'off', ref 142)
  gr_MIP_Options_for_Primal_Heuristics.'VndVariableNeighborhoodSearch'.S.(def 'off', ref 213)
/;
set oe(o,e) /
