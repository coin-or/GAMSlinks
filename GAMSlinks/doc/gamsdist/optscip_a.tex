...
\printoption{constraints/abspower/addvarbounds}%
{boolean}%
{TRUE}%
...
\printoption{constraints/quadratic/defaultbound}%
{$0\leq\textrm{real}$}%
{$\infty$}%
...
\printoption{heuristics/undercover/maxcoversize}%
{$0\leq\textrm{real}\leq1$}%
{$1$}%
...
\printoption{propagating/pseudoobj/maxcands}%
{$-1\leq\textrm{integer}$}%
{$100$}%
...
\printoption{separating/closecuts/separootonly}%
{boolean}%
{TRUE}%
