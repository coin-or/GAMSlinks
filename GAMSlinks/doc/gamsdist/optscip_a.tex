...
\printoption{constraints/quadratic/replacesqrbinary}%
{boolean}%
{TRUE}%
...
\printoption{constraints/quadratic/fastpropagate}%
{boolean}%
{TRUE}%
...
\printoption{constraints/quadratic/strategy}%
{character}%
{r}%
{strategy to use for selecting branching variable: b: rb-int-br, r: rb-int-br-rev, i: rb-inf}%
{}

\printoption{constraints/quadratic/mindistbrpointtobound}%
...
\printoption{heuristics/nlp/resolvefromscratch}%
{boolean}%
{TRUE}%
...
\printoption{heuristics/nlp/iteroffset}%
{$0\leq\textrm{integer}$}%
{$500$}%
{number of iterations added to the contingent of the total number of iterations}%
{}

\printoption{heuristics/nlp/iterquotient}%
{$0\leq\textrm{real}$}%
{$0.1$}%
{contingent of NLP iterations in relation to the number of nodes in SCIP}%
{}

\printoption{heuristics/nlp/itermin}%
{$0\leq\textrm{integer}$}%
{$300$}%
{contingent of NLP iterations in relation to the number of nodes in SCIP}%
{}

\printoption{heuristics/nlp/varboundexplicit}%
{boolean}%
{TRUE}%
