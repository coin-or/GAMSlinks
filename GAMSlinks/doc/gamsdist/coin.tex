...
They are currently available for Linux (32 and 64 bit), Windows (32 bit), Sun Solaris (Intel 64 bit), and Darwin (Intel 32 bit) systems.
...
% To pass those options to the MIP subsolver, you have to replace the prefix ``\texttt{bonmin.}'' with ``\texttt{milp\_sub.}''.
