...
\item CoinGlpk 4.37: Gnu Linear Programming Kit\\
(model types: LP, MIP, RMIP)
\item CoinIpopt 3.6: Interior Point Optimizer\\
...
\section{CoinBonminD, CoinCbcD, CoinIpoptD}

For Bonmin, Cbc, and Ipopt, experimental in-core communication links have been added.
They offer in-core communication between GAMS and the solver, making potentially large model scratch files unnecessary.
The current in-core communication links support all features of the traditional ones, except for branching priorities and the GAMS branch-cut-heuristic facility (BCH).
