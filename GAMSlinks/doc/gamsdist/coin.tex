...
% \end{tabular}
% \end{center}
% % $\strut^*$ option is available for MILP subsolver (it is only passed if the {\tt milp\_subsolver} option is set to {\tt Cbc\_Par}).
% \caption{\label{tab:bonminoptions}Compatibility of some Bonmin options with different algorithms.}
% \end{table}
