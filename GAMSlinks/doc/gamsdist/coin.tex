...
For Bonmin, Cbc, and Ipopt, experimental in-core communication links are available.
They offer in-core communication between GAMS and the solver, making potentially large model scratch files unnecessary.
The current in-core communication links support all features of the traditional ones, except for the GAMS branch-cut-heuristic facility (BCH).
