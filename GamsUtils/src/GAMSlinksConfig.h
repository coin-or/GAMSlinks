...
#ifndef __GAMSUTILSCONFIG_H__
#define __GAMSUTILSCONFIG_H__
...
#define COIN_GAMSLINKS_CHECKLEVEL 0

/* Define to the debug verbosity level (0 is no output) */
#define COIN_GAMSLINKS_VERBOSITY 0

/* If defined, the GAMS I/O Library is available. */
#define COIN_HAS_GAMSIO 1

/* Define to 1 if the GAMSlinks package is used */
#define COIN_HAS_GAMSUTILS 1

#endif /* HAVE_CONFIG_H */

#endif /*__GAMSUTILSCONFIG_H__*/
