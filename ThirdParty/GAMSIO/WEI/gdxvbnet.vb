...
public delegate sub tdatastoreproc(byref indx as integer,byref vals as double)
...
private declare function xcreate lib "gdxdclib" (byref pgdx as intptr) as boolean
private declare function xfree   lib "gdxdclib" (byref pgdx as intptr) as boolean
...
public function gdxdatareadstr(byval pgdx as intptr,byref astrelements() as string,byref avals() as double,byref afdim as integer) as integer
   dim cpy_astrelements(gms_maxdim,str_len) as byte
...
public function gdxdatasliceuels(byval pgdx as intptr,byref aindx() as integer,byref auels() as string) as integer
   dim cpy_auels(gms_maxdim,str_len) as byte
