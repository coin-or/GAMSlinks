...
var gdxAutoConvert          : function (pgdx: pointer; NV: Integer): Integer; {$I decorate};
...
Function  d_gdxAutoConvert(pgdx: pointer; NV: Integer): Integer; {$I decorate};
begin
gdxErrorHandling('gdxAutoConvert could not be loaded from ' + LibFileName + ' or has wrong signature!');
Result := 0;
end;
