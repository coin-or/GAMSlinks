...
#define _P3strcat(a,max,b,c) cioP3_strcat(a,max,b,c)
#define _P3strcpy(d,max,s)   cioP3_strcpy(d,max,s)
#define _P3inc0(x)       ++(x)
...
extern SYSTEM_char *cioP3_strcat(SYSTEM_char *d,  SYSTEM_char max,
                               SYSTEM_char *p1, SYSTEM_char *p2);
extern SYSTEM_byte *cioP3_strcpy(SYSTEM_byte *d,  SYSTEM_integer max,
			       SYSTEM_byte *s);
extern SYSTEM_double  cioSYSTEM_sqr_r(SYSTEM_double x);
extern SYSTEM_double  cioSYSTEM_int(SYSTEM_double x);
extern SYSTEM_double  cioSYSTEM_frac(SYSTEM_double x);
extern SYSTEM_longint cioSYSTEM_round(SYSTEM_double x);
extern void cioP3setlength(SYSTEM_byte *s, SYSTEM_integer l, SYSTEM_integer m);
...
#define cioMATH_P3_arccos(x) acos(x)
Function(SYSTEM_double ) cioMATH_P3_arcsin(SYSTEM_double x);
Function(SYSTEM_double ) cioMATH_P3_arctan2(SYSTEM_double y,SYSTEM_double x);
Function(SYSTEM_double ) cioMATH_P3_tan(SYSTEM_double x);
